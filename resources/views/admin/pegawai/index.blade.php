                        ...
                        <div @keydown.escape.stop="open = false" @click.away="open = false" class="inline-block text-left">
                            ...
                            <div x-show="open"
                                ...
                                <div class="py-1" role="none">
                                    <a href="{{ route('admin.pegawai.edit', $pegawai->id) }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="menu-item-0-{{$pegawai->id}}">
                                    ...
                                    <form action="{{ route('admin.pegawai.destroy', $pegawai->id) }}" method="POST" role="none">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="group flex w-full items-center px-4 py-2 text-sm text-red-600 hover:bg-red-100" role="menuitem" tabindex="-1" id="menu-item-1-{{$pegawai->id}}" onclick="return confirm('Apakah Anda yakin ingin menghapus pegawai ini?')">
