    ...
    <div class="flex justify-center mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl">
            ...
            <div class="p-4 rounded-xl text-white shadow-lg bg-gradient-to-br from-amber-400 to-yellow-500 flex items-center justify-between min-h-[100px] transform transition-transform hover:scale-105">
                <div>
                    <span class="text-2xl font-bold">{{ number_format($overall_performance_percentage, 1) }}%</span>
            ...
            <div class="p-4 rounded-xl text-white shadow-lg bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-between min-h-[100px] transform transition-transform hover:scale-105">
                <div>
                    <span class="text-2xl font-bold">{{ number_format($average_achievement_percentage, 1) }}%</span>
    ...
    <div class="flex justify-center mb-6">
        <div class="flex flex-wrap gap-6 w-full max-w-4xl">
            ...
            <div class="flex-1 min-w-[150px] bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center transform transition-transform hover:scale-105">
                ...
                <p class="text-3xl font-bold {{ $score_color }}">{{ number_format($total_score, 2) }}</p>
            </div>
            <!-- Hijau -->
            <div class="flex-1 min-w-[150px] bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center transform transition-transform hover:scale-105">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500 @if($indikator->target == 0) bg-[repeating-linear-gradient(-45deg,theme(colors.white),theme(colors.white)_10px,theme(colors.gray.50)_10px,theme(colors.gray.50)_20px)] @endif">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center @if($indikator->target == 0) bg-[repeating-linear-gradient(-45deg,theme(colors.white),theme(colors.white)_10px,theme(colors.gray.50)_10px,theme(colors.gray.50)_20px)] @endif">
                            @if($indikator->target == 0)
                                <span class="text-gray-400 italic text-xs">—</span>
                            @else
                                @php
