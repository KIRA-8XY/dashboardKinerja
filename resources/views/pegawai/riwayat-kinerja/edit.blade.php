...
<div class="max-w-xl mx-auto bg-white rounded-lg shadow p-6">
    ...
    <form action="{{ route('pegawai.riwayat-kinerja.update', $riwayat->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_indikator" value="{{ $riwayat->nama_indikator }}" class="w-full rounded border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" required>
        </div>
        <div class="mb-4">
            <label class="block mb-1">Target</label>
            <input type="number" name="target" value="{{ $riwayat->target }}" class="w-full rounded border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" required>
        </div>
        <div class="mb-4">
            <label class="block mb-1">Realisasi</label>
            <input type="number" name="realisasi" value="{{ $riwayat->realisasi }}" class="w-full rounded border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="tahun" value="{{ $riwayat->tahun }}" class="w-full rounded border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400" required>
        </div>
