            ...
            <?php if(session('status')): ?>
                <div class="mb-6 p-4 rounded-lg bg-red-50 border border-red-200">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-red-700"><?php echo e(session('status')); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dashboardKinerja/resources/views/auth/login.blade.php ENDPATH**/ ?>