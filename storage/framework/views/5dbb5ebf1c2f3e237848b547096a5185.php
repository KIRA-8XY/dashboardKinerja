...
<div class="max-w-xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.indikator.update', $indikator->id)); ?>" method="POST" class="space-y-4 bg-white rounded-xl shadow p-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <select name="pegawai_id"
                ...
                <?php $__currentLoopData = $pegawais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($pegawai->id); ?>" <?php echo e($indikator->pegawai_id == $pegawai->id ? 'selected' : ''); ?>><?php echo e($pegawai->nama); ?></option>
        ...
        <div>
            ...
            <input type="text" name="nama_indikator"
                ...
                value="<?php echo e($indikator->nama_indikator); ?>" required>
        </div>
        <div>
            <label class="block mb-1 font-semibold">Target</label>
            <input type="number" name="target"
                class="w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400"
                value="<?php echo e($indikator->target); ?>" required>
        </div>
        <div>
            <label class="block mb-1 font-semibold">Realisasi</label>
            <input type="number" name="realisasi"
                class="w-full rounded border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400"
                value="<?php echo e($indikator->realisasi); ?>" required>
        </div>
        <div class="mb-4">
            <label for="max_score" class="block text-gray-700 text-sm font-bold mb-2">Skor Maksimal</label>
            <input type="number" step="0.01" name="max_score" id="max_score" value="<?php echo e(old('max_score', $indikator->max_score)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dashboardKinerja/resources/views/admin/indikator/edit.blade.php ENDPATH**/ ?>