...
<head>
    ...
    <?php if(Auth::check()): ?>
        <script>
            window.location.href = "<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('pegawai.dashboard')); ?>";
        </script>
    <?php endif; ?>
</head>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dashboardKinerja/resources/views/welcome.blade.php ENDPATH**/ ?>