...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 antialiased min-h-screen">
        <div class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-cyan-900 to-blue-900">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dashboardKinerja/resources/views/layouts/guest.blade.php ENDPATH**/ ?>