<?php $__env->startSection('title', 'Manajemen Indikator'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto px-4 space-y-6">
    <?php if(request()->has('q')): ?>
    <div class="mb-4">
        <a href="<?php echo e(route('admin.indikator.index')); ?>" class="inline-flex items-center text-cyan-600 hover:text-cyan-700 font-medium transition-colors duration-200">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3 items-center">
            ...
            <form method="GET" class="flex items-center gap-2" onsubmit="return validateSearchForm(this)">
                <div class="relative">
                    <input type="text" name="q" id="searchInput" value="<?php echo e(request('q')); ?>" placeholder="Cari indikator/pegawai"
                ...
                <input type="hidden" name="per" value="<?php echo e($perPage); ?>">
                ...
                <form method="GET">
                    ...
                    <div class="relative">
                        <select name="mode" onchange="this.form.submit()" class="appearance-none bg-white border border-gray-300 text-sm rounded-lg pl-3 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 shadow-sm">
                            <option value="default" <?php echo e($mode==='default' ? 'selected' : ''); ?>>Default</option>
                            <option value="pegawai" <?php echo e($mode==='pegawai' ? 'selected' : ''); ?>>Group by Pegawai</option>
                            <option value="indikator" <?php echo e($mode==='indikator' ? 'selected' : ''); ?>>Group by Indikator</option>
                            <option value="target_desc" <?php echo e($mode==='target_desc' ? 'selected' : ''); ?>>Target Tertinggi</option>
                            <option value="target_asc" <?php echo e($mode==='target_asc' ? 'selected' : ''); ?>>Target Terendah</option>
                            <option value="realisasi_desc" <?php echo e($mode==='realisasi_desc' ? 'selected' : ''); ?>>Realisasi Tertinggi</option>
                            <option value="realisasi_asc" <?php echo e($mode==='realisasi_asc' ? 'selected' : ''); ?>>Realisasi Terendah</option>
                        </select>
                    </div>
                </form>
            </div>
            <form method="GET" class="relative">
                ...
                <select name="per" onchange="this.form.submit()" class="appearance-none bg-white border border-gray-300 text-sm rounded-lg pl-3 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 shadow-sm">
                    <?php $__currentLoopData = [10,15,25,50,100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($size); ?>" <?php echo e($perPage==$size ? 'selected' : ''); ?>><?php echo e($size); ?> / halaman</option>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-visible animate-fade-up" style="animation-delay: 0.3s">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if($grouped): ?>
                    <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="bg-cyan-50 animate-fade-up" style="animation-delay: <?php echo e(0.4 + ($loop->index * 0.05)); ?>s">
                            <td colspan="7" class="px-4 py-2 font-semibold text-cyan-700"><?php echo e($groupKey); ?></td>
                        </tr>
                            ...
                            <tr x-data="{ open: false }" class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($indikator->pegawai->nama); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($indikator->pegawai->jabatan ?? ''); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($color); ?>">
                                        <?php echo e($score); ?>/<?php echo e(number_format($indikator->max_score, 2)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right relative" :class="{'z-10': open}">
                                    <div @keydown.escape.stop="open = false" @click.away="open = false" class="inline-block text-left">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 z-20 mt-2 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button-<?php echo e($indikator->id); ?>" tabindex="-1" style="display: none;">
                                            <div class="py-1" role="none">
                                                <a href="<?php echo e(route('admin.indikator.edit', $indikator->id)); ?>" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="menu-item-0-<?php echo e($indikator->id); ?>">
                                                ...
                                                <form action="<?php echo e(route('admin.indikator.destroy', $indikator->id)); ?>" method="POST" role="none">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="group flex w-full items-center px-4 py-2 text-sm text-red-600 hover:bg-red-100" role="menuitem" tabindex="-1" id="menu-item-1-<?php echo e($indikator->id); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus indikator ini?')">
    ...
    <div class="mt-4"><?php echo e($indikators->links()); ?></div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dashboardKinerja/resources/views/admin/indikator/index.blade.php ENDPATH**/ ?>